...
System.register([], function (exports, module) {
    ...
    return {
        execute: function () {
            var _this = this;
            var NAMESPACE = 'sepro-venn';
            var BUILD = /* sepro-venn */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: true, cssAnnotations: true, cssVarShim: true, devTools: false, disconnectedCallback: false, dynamicImportShim: true, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, initializeNextTick: true, isDebug: false, isDev: true, isTesting: true, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: true, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: false, propNumber: true, propString: true, reflect: false, safari10: true, scoped: false, scriptDataOpts: true, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: false, slotChildNodesFix: false, slotRelocation: false, state: false, style: true, svg: true, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: false, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: false, vdomText: true, vdomXlink: false, watchCallback: true };
            var scopeId;
            var contentRef;
            var hostTagName;
            var i = 0;
            ...
            var getElement = function (ref) { return (BUILD.lazyLoad ? getHostRef(ref).$hostElement$ : ref); };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, module.import('./shadow-css-12fa151b.system.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
                        case 5:
                            style_1 = _a.sent();
                            _a.label = 6;
                        case 6:
            ...
            var patchEsm = exports('a', function () {
                ...
                if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
                    // @ts-ignore
                    return module.import(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-71ddec17.system.js').then(function () {
            ...
            var patchBrowser = exports('p', function () {
                ...
                if (!BUILD.safari10 && importMeta !== '') {
                    ...
                    if (BUILD.dynamicImportShim && !win.customElements) {
                        ...
                        // @ts-ignore
                        return module.import(/* webpackChunkName: "polyfills-dom" */ './dom-09a02333.system.js').then(function () { return opts; });
                    }
                }
            ...
            var patchCloneNodeFix = function (HTMLElementPrototype) {
                ...
                HTMLElementPrototype.cloneNode = function (deep) {
                    ...
                    if (deep) {
                        for (var i_9 = 0; i_9 < srcChildNodes.length; i_9++) {
                            // Node.ATTRIBUTE_NODE === 2, and checking because IE11
                            if (srcChildNodes[i_9].nodeType !== 2) {
                                clonedNode.appendChild(srcChildNodes[i_9].cloneNode(true));
                            }
                        }
                    }
                    return clonedNode;
